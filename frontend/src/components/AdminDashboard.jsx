...
const AdminDashboard = () => {
  ...
  const handleRegister = async () => {
    try {
      const res = await axios.post("https://dce-attendance.onrender.com/api/admin/register-student", formData, {
  ...
  const handlePromote = async () => {
    try {
      const res = await axios.put("https://dce-attendance.onrender.com/api/admin/promote-semester", { currentSemester: promotionSemester }, {
        headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
      });
      alert(res.data.message);
    } catch (err) {
  ...
  const handleUpdateSemester = async () => {
    try {
      const res = await axios.put("https://dce-attendance.onrender.com/api/admin/update-student-semester", updateData, {
        headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
      });
      alert(res.data.message);
    } catch (err) {
